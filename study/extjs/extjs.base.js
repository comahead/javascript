    ...
    Ext.apply(Base, {
        ...
        extend: function(parent) {
            var parentPrototype = parent.prototype,
                basePrototype, thisProto, i, ln, name, statics;

            thisProto = this.prototype = Ext.Object.chain(parentPrototype);
            thisProto.self = this;

            this.superclass = thisProto.superclass = parentPrototype;
            ...
            thisProto.config = new thisProto.configClass();
            thisProto.initConfigList = thisProto.initConfigList.slice();
            thisProto.initConfigMap = Ext.clone(thisProto.initConfigMap);
            thisProto.configMap = Ext.Object.chain(thisProto.configMap);
        },
