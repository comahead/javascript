(function () {
    ...
    function s(a) {
        for (var a = a.split("."), b = q, c; c = a.shift();) if (b[c] != l) b = b[c];
        else return l;
        return b
    }
    function aa() {}
    ...
    var la = "closure_uid_" + Math.floor(2147483648 * Math.random())
        .toString(36),
        ma = 0;
    ...
    function t(a, b, c) {
        t = Function.prototype.bind && -1 != Function.prototype.bind.toString()
    ...
    function Ga(a) {
        if (-1 != a.indexOf("&")) if ("document" in q) var b = {
            "&amp;": "&",
            "&lt;": "<",
            "&gt;": ">",
            "&quot;": '"'
    ...
    function Ma(a, b) {
        for (var c = 0, d = va(String(a))
            ...
            do {
                ...
                c = ((0 == D[1].length ? 0 : parseInt(D[1], 10)) < (0 == G[1].length ? 0 : parseInt(G[1], 10)) ? -1 : (0 == D[1].length ? 0 : parseInt(D[1], 10)) > (0 == G[1].length ? 0 : parseInt(G[1], 10)) ? 1 : 0) || ((0 == D[2].length) < (0 == G[2].length) ? -1 : (0 == D[2].length) > (0 == G[2].length) ? 1 : 0) || (D[2] < G[2] ? -1 : D[2] > G[2] ? 1 : 0)
            } while (0 == c)
        }
        return c
    }
    ...
    var Oa = Array.prototype,
        Pa = Oa.indexOf ? function (a, b, c) {
            ...
            for (var d = a.length, e = [], f = 0, g = ga(a) ? a.split("") : a, i = 0; i < d; i++) if (i in g) {
                var n = g[i];
    ...
    function Ta(a, b, c) {
        for (var d = a.length, e = ga(a) ? a.split("") : a, f = 0; f < d; f++) if (f in e && b.call(c, e[f], f, a)) return f;
        return -1
    }
    function Ua(a, b) {
        return 0 <= Pa(a, b)
    ...
    function $a(a, b) {
        for (var c = 1; c < arguments.length; c++) {
            ...
            else if (e) for (var f = a.length, g = d.length, i = 0; i < g; i++) a[f + i] = d[i];
            else a.push(d)
        }
    }
    ...
    function hc(a, b) {
        ...
        d && (ga(d) ? f.className = d : ea(d) ? x.apply(l, [f].concat(d)) : mb(d, function (a, b) {
            "style" == b ? f.style.cssText = a : "class" == b ? f.className = a : "for" == b ? f.htmlFor = a : b in bc ? f.setAttribute(bc[b], a) : 0 == b.lastIndexOf("aria-", 0) || 0 == b.lastIndexOf("data-", 0) ? f.setAttribute(b, a) : f[b] = a
        }));
    ...
    function tc(a, b) {
        if ("textContent" in a) a.textContent = b;
            ...
            a.firstChild.data = b
        } else lc(a), a.appendChild(ac(a)
            .createTextNode(b))
    }
    function uc(a, b, c, d) {
        if (a != l) for (a = a.firstChild; a;) {
    ...
    function zc(a, b, c) {
        if (!(a.nodeName in vc)) if (3 == a.nodeType) c ? b.push(String(a.nodeValue)
            .replace(/(\r\n|\r|\n)/g, "")) : b.push(a.nodeValue);
        else if (a.nodeName in xc) b.push(xc[a.nodeName]);
        else for (a = a.firstChild; a;) zc(a, b, c), a = a.nextSibling
    }
    function Ac(a, b, c) {
        if (!b && !c) return l;
    ...
    function Oc(a, b, c) {
        for (var d = a.elements, e, f = 0; e = d[f]; f++) if (!(e.form != a || e.disabled || "fieldset" == e.tagName.toLowerCase())) {
            ...
            case "select-multiple":
                e = Sc(e);
                if (e != l) for (var i, n = 0; i = e[n]; n++) c(b, g, i);
                break;
            default:
                i = Sc(e), i != l && c(b, g, i)
            }
    ...
    }, Zc = {}, $c = Date.now || function () {
            return +new Date
        }, ad = 0;
    $c();
    !window.console || eval("/*@cc_on!@*/false");
    var bd;
    ...
    cd.prototype.f = function (a) {
        ...
        if (a.state) if (a = a.state, b == this.ha) this.b = a["spf-timestamp"], window.history.replaceState(a, "", b);
        else {
    ...
    var kd = Array.prototype.indexOf ? function (a, b) {
            ...
            for (var c = jd(a), d = 0, e = c.length; d < e; d++) if (c[d] == b) return k;
            return m
    ...
    function md(a) {
        return a.dataset ? a.dataset.loaded : a.getAttribute("data-" + "loaded".replace(/([A-Z])/g, "-$1")
            .toLowerCase())
    };
    ...
    function pd(a, b) {
        if (a in od) for (var c = od[a], d = Array.prototype.slice.call(arguments, 1), e = 0, f = c.length; e < f; e++) c[e] && c[e][0].apply(c[e][1], d)
    }
    function qd(a) {
                        ...
                        if (a[1]) {
                            ...
                            if (n) a && a();
                                ...
                                y.onload = function () {
                                    if (!md(r)) {
                                        var a = r;
                                        a.dataset ? a.dataset.loaded = "true" : a.setAttribute("data-" + "loaded".replace(/([A-Z])/g, "-$1")
                                            .toLowerCase(), "true");
                                        pd(g);
                                        qd(g)
                                    }
    ...
    function zd(a, b, c, d) {
        ...
        b && b(a, i);
            ...
            var i = Zc["request-timeout"],
                r = e || function () {},
                y = f || function () {}, D = f || function () {}, G, H = td();
            H.open("GET", g, k);
            var ka = H.abort;
            H.abort = function () {
                clearTimeout(G);
    ...
    function Ad(a, b, c) {
        ...
        var f = 0,
            e = a.html || {};
        if (Object.keys) f = Object.keys(e)
            .length;
        else for (var g in e) f++;
        for (g in e) if (e = document.getElementById(g)) {
            ...
            if (!Bd || !kd(e, Zc["transition-class"])) e.innerHTML = a.html[g], sd(a.html[g], function () {
                ...
                r.reverse = !! b;
                r.ib = e;
                r.sg = Zc["transition-current-child-class"];
                ...
                n.push([function (a, b) {
                    ...
                    var c = a.Db,
                        d, e = c.parentNode;
                    if (e && 11 != e.nodeType) if (c.removeNode) c.removeNode(m);
                    else {
    ...
    function Cd(a, b) {
        if (a in Dd) if (0 < Dd[a].Wd.length) {
            var c = Dd[a].Wd.shift();
    ...
    var yd = m,
        Dd = {}, Bd;
    a: {
        for (var Ed = document.createElement("div"), Fd = ["Webkit", "Moz", "Ms", "O", "Khtml"], Gd = 0, Hd = Fd.length; Gd < Hd; Gd++) if (Fd[Gd] + "Transition" in Ed.style) {
            Bd = k;
            break a
        }
        Bd = m
    ...
    function Id(a) {
        ...
        for (c in Yc) {
            ...
            Zc[c] = d;
            var e;
            if (e = b) if (e = d) e = c.length - 9, e = 0 <= e && c.indexOf("-callback", e) == e;
            e && nd(c, d)
        }
    ...
    function O(a, b, c) {
        var d = b || {};
        if (a = a in Md ? Md[a] : c) for (var e in d) a = a.replace(RegExp("\\$" + e, "gi"), function () {
            return d[e]
        });
        return a
    }
    ra = function (a, b) {
        var c = b || {}, d = a in Md ? Md[a] : a;
        if (d) for (var e in c) var f = ("" + c[e])
            .replace(/\$/g, "$$$$"),
    ...
    function ie(a, b) {
        ...
        if (a.hasChildNodes()) for (var c = 0, d; d = a.childNodes[c]; ++c) ie(d, b)
    }
    function je() {
        var a = document;
    ...
    function Ae(a, b, c, d, e, f) {
        ...
        d = 0 > d ? "" : 0 == d ? ";expires=" + (new Date(1970, 1, 1))
            .toUTCString() : ";expires=" + (new Date(qa() + 1E3 * d))
            .toUTCString();
        a.b.cookie = b + "=" + c + f + e + d + ""
    }
    p = ye.prototype;
    p.get = function (a, b) {
        for (var c = a + "=", d = (this.b.cookie || "")
            .split(ze), e = 0, f; f = d[e]; e++) {
    ...
    p.Z = function () {
        return !this.b.cookie ? 0 : (this.b.cookie || "")
            .split(ze)
            .length
    };
    p.clear = function () {
        for (var a = Ce(this)
            .keys, b = a.length - 1; 0 <= b; b--) Be(this, a[b])
    };

    function Ce(a) {
        for (var a = (a.b.cookie || "")
            .split(ze), b = [], c = [], d, e, f = 0; e = a[f]; f++) d = e.indexOf("="), - 1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
        return {
            keys: b,
            Rf: c
        }
    ...
    function Ye(a) {
        ...
        for (var b = ac(a), c = We(a, "position"), d = "fixed" == c || "absolute" == c, a = a.parentNode; a && a != b; a = a.parentNode) if (c = We(a, "position"), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c || "absolute" == c || "relative" == c)) return a;
        return l
    }

    function Ze(a) {
        for (var b = new Qe(0, Infinity, Infinity, 0), c = Zb(a), d = c.b.body, e = c.b.documentElement, f = !Fb && dc(c.b) ? c.b.documentElement : c.b.body; a = Ye(a);) if ((!E || 0 != a.clientWidth) && (!Fb || 0 != a.clientHeight || a != d) && a != d && a != e && "visible" != We(a, "overflow")) {
            var g = $e(a),
                i;
            i = a;
            if (Eb && !Sb("1.9")) {
    ...
    function $e(a) {
        ...
        if (a.getBoundingClientRect) b = Xe(a), a = Ec(Zb(c)), f.x = b.left + a.x, f.y = b.top + a.y;
            ...
            for (b = a;
            (b = Ye(b)) && b != c.body && b != g;) if (f.x -= b.scrollLeft, !Db || "TR" != b.tagName) f.y -= b.scrollTop
        }
        return f
    }
    ...
    function bf(a) {
        ...
        } else e = ha(a.Hg), f = a, a.targetTouches ? f = a.targetTouches[0] : e && a.Ia.targetTouches && (f = a.Ia.targetTouches[0]), b.x = f.clientX, b.y = f.clientY;
        return b
    }
    function df(a, b) {
    ...
    function Af(a, b, c) {
        if (ea(b)) for (var d = 0; d < b.length; d++) Af(a, String(b[d]), c);
    ...
    function Jf(a) {
        return -1 != a.indexOf("?") ? (a = (a || "")
            .split("#")[0], a = a.split("?", 2), Hf(1 < a.length ? a[1] : a[0])) : {}
    }
    function Kf(a) {
    ...
    function Wf(a) {
        if (3 > a.Da) if (1 > a.Da) {
            ...
            if (b = c) {
                ...
                0 <= d && (b = b.substr(d + 15));
                for (var d = b.split(" "), e = "", b = "", f = 0, g = d.length; f < g; f++) if (e) if (b) break;
                else b = d[f];
                else e = d[f];
                e = e.split(".");
                d = parseInt(e[0], 10) || 0;
            ...
            if (!e || !f) N(function () {
                ...
                cg(function (b) {
                    if (Xf(b, a.minVersion)) {
                        ...
                        a.urlV9As2, a);
                        else if (g != a.urlV8 || d) if (ag(f, a.urlV8, a), b = F("flash10-promo-div")) U(b), b = He.getInstance(), b = parseInt(b.get("ftuc") || 0, 10) + 1, Me("ftuc", b), Pe()
    ...
    p.za = function (a, b) {
        ...
        if (c) {
            ...
            this.Vb--;
            if (this.c && 0 == this.Vb) for (; c = this.c.pop();) this.Ub(c);
            return 0 != e
        }
        return m
    };
    ...
    function Gg(a, b, c, d, e) {
        ...
        if ("open" in f) {
            ...
            f.open(c, a, k);
            a = "POST" == c;
            if (e) for (var g in e) f.setRequestHeader(g, e[g]), "content-type" == g.toLowerCase() && (a = m);
    ...
    function Kg(a, b) {
        ...
        return Gg(a, function (a) {
            if (Fg(a)) {
                ...
                c && (b ? (b = Lg(r, "redirect_on_success"), y && b ? window.location = b : ((r = Lg(r, 0 == y ? "success_message" : "error_message")) && alert(r), a = g ? eval("(" + D + ")") : a, 0 == y ? c(a) : d && d(a))) : a.responseText && c(a))
            } else e && e(a)
    ...
    function Ug(a, b, c) {
        ...
        e && (d = "scriptload-" + (Math.floor(2147483648 * Math.random())
            .toString(36) + Math.abs(Math.floor(2147483648 * Math.random()) ^ qa())
            .toString(36)));
        b && ig(d, b);
        var i, b = d,
        ...
        n.onreadystatechange = function () {
            if ("loaded" == n.readyState || "complete" == n.readyState) n.onload()
        };
        n.src = a;
    ...
    function Vg(a, b) {
        var c = vf(a);
        if (c == vf(window.location.href) || !c && 0 == a.lastIndexOf("/", 0)) if (c = xf(a), c = yf(c)) {
    ...
    function dh(a, b, c, d, e, f, g) {
        ...
        if (f) {
            if (e) {
                ...
                i.x + g.width > e.right && f & 1 && (i.x = Math.max(e.right - g.width, e.left), d |= 1);
        ...
        b.style.left = df(a, e);
        b.style.top = df(f, e);
        if (!(c == g || (!c || !g ? 0 : c.width == g.width && c.height == g.height))) a = Dc(Zb(ac(b))), E && (!a || !Sb("8")) ? (c = b.style, a ? (E ? (a = hf(b, Ve(b, "paddingLeft")), e = hf(b, Ve(b, "paddingRight")), f = hf(b, Ve(b, "paddingTop")), d = hf(b, Ve(b, "paddingBottom")), a = new Qe(f, e, d, a)) : (a = Ue(b, "paddingLeft"), e = Ue(b, "paddingRight"), f = Ue(b, "paddingTop"), d = Ue(b, "paddingBottom"), a = new Qe(parseFloat(f), parseFloat(e), parseFloat(d), parseFloat(a))), E ? (e = kf(b, "borderLeft"), f = kf(b, "borderRight"), d = kf(b, "borderTop"), b = kf(b, "borderBottom"), b = new Qe(d, f, b, e)) : (e = Ue(b, "borderLeftWidth"), f = Ue(b, "borderRightWidth"), d = Ue(b, "borderTopWidth"), b = Ue(b, "borderBottomWidth"), b = new Qe(parseFloat(d), parseFloat(f), parseFloat(b), parseFloat(e))), c.pixelWidth = g.width - b.left - a.left - a.right - b.right, c.pixelHeight = g.height - b.top - a.top - a.bottom - b.bottom) : (c.pixelWidth = g.width, c.pixelHeight = g.height)) : (b = b.style, Eb ? b.MozBoxSizing = "border-box" : Fb ? b.WebkitBoxSizing = "border-box" : b.boxSizing = "border-box", b.width = Math.max(g.width, 0) + "px", b.height = Math.max(g.height, 0) + "px");
        return i
    };
    var eh = {}, fh = "ontouchstart" in document;
    ...
    function ih(a) {
        ...
        if ("HTML" != a.target.tagName && c) {
            ...
            if (b = eh[a.type]) for (d in b.W)(e = hh(a.type, d, a.target)) && b.za(d, e, a.type, a)
        }
    }
    ...
    function uh(a, b, c) {
        ...
        n = new jb(0, 1);
        B(b, Y(a, "center-menu")) && (n.x -= Math.round((ef(c)
            .width - ef(b)
            .width) / 2));
    ...
    p.Sc = function (a) {
        if (a) {
            ...
            if (b) {
                ...
                this.getData(a, "button-has-sibling-menu") ? a.parentNode.appendChild(b) : vh(this, a)
                    .appendChild(b);
    ...
    p.Fg = function (a, b) {
        ...
        if (!Cc(c, Y(this, "menu")) || B(c, Y(this, "menu-item")) || B(c, Y(this, "menu-close"))) if (qh(this, a), (d = Cc(c, Y(this, "menu"))) && this.getData(a, "button-menu-indicate-selected"))(e = K(Y(this, "content"), a)) && tc(e, yc(c)), e = Y(this, "menu-item-selected"), (d = K(e, d)) && z(d, e), x(c.parentNode, e)
    };
    ...
    function Hh(a, b) {
        ...
        i = g.join(",");
        if (d.noreferrer) {
            if (d = e.open("", f, i)) E && -1 != c.indexOf(";") && (c = "'" + c.replace(/'/g, "%27") + "'"), d.opener = l, Fb ? d.location.href = c : (c = za(c), d.document.write('<META HTTP-EQUIV="refresh" content="0; url=' + c + '">'), d.document.close())
        } else d = e.open(c, f, i);
        c = d;
        if (!c) return l;
    ...
    function Xh(a, b) {
        ...
        return Ra(b, function (a) {
            ...
            a: {
                ...
                for (var f = ga(c) ? c.split("") : c, g = c.length - 1; 0 <= g; g--) if (g in f && b.call(j, f[g])) {
                    b = g;
                    break a
                }
                b = -1
        ...
        X("/addto_ajax?action_move_playlist_video=1", {
            ...
            onError: function () {
                ...
                a: if (e = this.K, !fa(e) || !fa(d) || e.length != d.length) e = m;
                    ...
                    for (var f = e.length, g = 0; g < f; g++) if (e[g] !== d[g]) {
                        e = m;
                        break a
                    }
                    e = k
    ...
    function ii(a) {
        ...
        if (B(g, "search-base") || F("search-base-div")) {
            ...
            n = J("ul", l, n)[0]
        } else if (B(g, "channel")) if (a = "channel", F("guide")) {
            if (b = F("feed") ? li : mi, (r = J("h1", j, j)[0]) && (c = yc(r)), r = K("channel-header-profile-image")) d = r.src
        } else {
            if (g = (g = he("li", "selected", F("channel-header-main"))) && nc(g)) if (g = g.href, r = Sa(g.split("/"), function (a, b, c) {
                return "user" == c[b - 2]
            }), !r) return l;
        ...
        try {
            ...
            y = b;
            b = [];
            for (var D, G, H, g = r = 0; g < n.length; g++) if (D = n[g], !si(D)) {
                var ka;
    ...
    Ci.prototype.b = function (a, b) {
        ...
        if (c) if (!b && Di(c)) Ci.prototype.Xb.call(this, a);
        else return c
    };
    ...
    function Qi(a, b) {
        Ki && Pi(function (a, d) {
            var e = Q(a, "group-key");
            Q(a, "thumb-manual") || e && !b || (e && Sg(a, e), e = "thumb-group-" + Mi(pf(a)
                .y), Rg(a, d, e), P(a, "group-key", e))
        }, a)
    }
    function Pi(a, b) {
        var c = J("img", l, b);
    ...
    function bj(a, b, c, d, e) {
        if (b) {
            ...
            if (g[i]) {
                n = g[i];
                for (f = 0; f < n.length; f++) if (g = n[f], g.eb == c && g.Tb == e) {
                    if (g.Pa) break;
                    return n[f].key
                }
            } else n = g[i] = [], g.Q++;
    ...
    function dj(a, b, c, d, e) {
        if (ea(b)) for (var f = 0; f < b.length; f++) dj(a, b[f], c, d, e);
        else if (d = !! d, a = ej(a, b, d)) for (f = 0; f < a.length; f++) if (a[f].eb == c && a[f].capture == d && a[f].Tb == e) {
            fj(a[f].key);
            break
        }
    }
    ...
    p.dispatchEvent = function (a) {
        ...
        if (b in c) {
            ...
            if (m in c) if (f = c[m], f.ba = f.Q, b) for (g = 0; !a.Ua && g < e.length && f.ba; g++) a.currentTarget = e[g], d &= hj(f, e[g], a.type, m, a) && a.fc != m;
            else for (e = this; !a.Ua && e && f.ba; e = e.ec) a.currentTarget = e, d &= hj(f, e, a.type, m, a) && a.fc != m;
            a = Boolean(d)
        } else a = k;
        return a
    };
    p.T = function () {
        ...
        if (this == l) mb($i, function (d) {
            ...
            var d = ja(this);
            if ($i[d]) for (var d = $i[d], e = d.length - 1; 0 <= e; e--) {
                var f = d[e];
                if (c || a == f.capture) fj(f.key), b++
            }
        }
    ...
    function nj(a, b, c, d, e, f) {
        if (ea(c)) for (var g = 0; g < c.length; g++) nj(a, b, c[g], d, e, f);
        else {
            a: {
                d = d || a;
                f = f || a.c || a;
                e = !! e;
                if (b = ej(b, c, e)) for (c = 0; c < b.length; c++) if (!b[c].Pa && b[c].eb == d && b[c].capture == e && b[c].Tb == f) {
                    b = b[c];
                    break a
                }
                b = l
    ...
    p.ic = function (a, b) {
        if (a) if (this.getData(a, "slider-ajax-url") && !this.getData(a, "slider-loaded")) Ej(this, a, t(this.ic, this, a, b));
        else {
            ...
            if (c) {
                ...
                if (g) {
                    ...
                    f ? c.style.top = i : af(g) ? c.style.right = i : c.style.left = i
                }
            }
    ...
    Fj.prototype.xc = function () {
        ...
        if (Gj()) {
            a = uj.getInstance();
            var b = this.b;
            if (b) if (a = I(Y(a, "scroll-unit"), b), 0 >= a.length) a = [];
            else {
                var c = b.scrollTop,
                    d = vj(a),
                    e = b.offsetHeight,
        ...
        case "save":
            this.vb() || (Pj(this), Uj(this, {
                ...
                j: function (a, c) {
                    ...
                    R(F("playlist-bar-save-form"), "submit", t(this.Wf, this))
                }
            }))
        }
    };
    ...
    p.bb = function (a) {
        ...
        this.g.$a() && this.g.Z() && !this.n && (this.n = k, Ug((L("DRAGDROP_BINARY_URL") || "") + "", t(function () {
            R(this.ka, "mouseover", t(function () {
                this.vc || (this.vc = k, this.g.$a() && !this.g.Y() && s("yt.www.lists.dragdrop")
                    .createDraggables())
            }, this));
    ...
    function Yj(a, b, c, d, e, f) {
        b && (a.b || (a.b = F("playlist-bar-notifications"), T(a.b, "click", t(a.Pf, a), "playlist-bar-undo")), a.Yb = f || l, a.Yb && (b += ' <a class="playlist-bar-undo">' + O("UNDO_LINK") + "</a>"), K("yt-alert-content", a.b)
            .innerHTML = b, b = K("yt-alert-icon", a.b), lf(b, !e), C(a.b, "yt-alert-error", !! c), C(a.b, "yt-alert-success", !c), U(a.b), a.Ea && (Ud(a.Ea), a.Ea = l), d && (c = t(function () {
            Sj(this)
        }, a), a.Ea = N(c, 1E4)))
    }
    ...
    function kk(a) {
        ...
        if (a) x(b, "watch-wide"), N(function () {
            lk();
            if (d) for (var a = 0; a < e.length; ++a) x(d, e[a])
        }, f);
        else {
            f /= 2;
            lk("small");
            if (d) for (var g = 0; g < e.length; ++g) z(d, e[g]);
            N(function () {
                z(b, "watch-wide")
            }, f);
            Oi(c)
        ...
        X(a, {
            ...
            j: function (a, b) {
                ...
                a: if (c = c.get("ems"), this.kb) {
                    ...
                    for (var d = 0; d < this.Ma.length; d++) {
                        var n = this.Ma[d];
                        if (n.value == c) {
                            n.selected = k;
                            wk.getInstance()
                    ...
                    wk.getInstance()
                        .Ga(this.va)
                } else(c in this.la ? this.la[c] : nb(this.la))
                    .select();
                Ak(this);
                this.ua()
            },
    ...
    p.Na = function () {
        ...
        var d = {}, a = I("share-embed-option", this.k);
        w(a, function (a) {
            d[a.name] = a
        });
    ...
    p.Kf = function (a) {
        ...
        var e = "rtl" == document.body.getAttribute("dir") ? "right" : "left",
            c = c ? "0px" : ef(b)
                .width + "px";
        a.style[e] = c;
        N(function () {
    ...
    p.Rb = function () {
        if (!B(this.X, "focused")) {
            ...
            var c;
            if (c = !this.i.disabled) if (c = this.i.checked) {
                var d = this.aa.value;
                c = ["h", "m", "s"];
                var e = Za(c);
                e.reverse();
                var f = {}, d = d.toLowerCase()
                    .match(/\d+\s*[hms]?/g) || [],
                    d = Qa(d, function (a) {
                        var b = (a.match(/[hms]/) || [""])[0];
                ...
                if (d.length || 59 < f.s || 59 < f.m || 9 < f.h) c = l;
                else {
                    var i = "";
                    w(c, function (a) {
                        f[a] && (i += f[a] + a)
    ...
    function Ik(a) {
        F("share-with-playlist")
            .checked = k;
        Gk(a)
    }

    function Gk(a) {
        var b = F("share-with-playlist")
            .checked;
        K("share-panel-start-at", a.e)
            .disabled = b;
        K("share-panel-start-at-time", a.e)
            .disabled = b
    }
    p.Lf = function () {
        Ik(this);
    ...
    function Hk(a, b, c) {
        ...
        X("share_ajax", {
            ...
            j: function (a, b) {
                ...
                this.td = b.url_long;
                this.Rb();
                F("share-services-container")
                    .innerHTML = b.share_services_html
            },
            B: a
        })
    };
    ...
    function al(a, b, c, d) {
        ...
        d = zb();
        (!d ? 0 : 0 <= d.toLowerCase()
            .indexOf("android 2.2")) ? d = k : (d = document.createElement("video"), d = !(!d || !d.canPlayType || !d.canPlayType('video/mp4; codecs="avc1.42001E, mp4a.40.2"') && !d.canPlayType('video/webm; codecs="vp8.0, vorbis"')));
        var d = d && (s("yt.player.Application") || a.assets.js),
            e = !! a.html5;
        d || (a.args.html5_unavailable = "1");
        var f = this.Lb ? this.De : this.Ee;
        e && d || c ? (this.pc = this.sc, c || (this.Nb = f)) : (this.pc = f, d && !b && (this.Nb = this.sc));
    ...
    $.kc = function (a) {
        ...
        Yg(["https:" == window.location.protocol ?
            "https://gg.google.com/csi" : "http://csi.gstatic.com/csi", "?v=2&s=youtube&action=", a, e, "&", g.join("&"), "&rt=", f.join(",")].join(""))
    };
    $.Tc = function () {
                    ...
                    if (c) {
                        if (f > e) {
                            var g = a.value,
                                ...
                                f = "",
                                r = 0;
                            do f += g[i - n], r = unescape(encodeURIComponent(f))
                                .length, n++;
                            while (r < e);
    ...
    function pl(a, b) {
        var c = a.value;
        return b ? unescape(encodeURIComponent(c))
            .length : c.length
    };
    ...
    function sl(a, b, c) {
        ...
        6 > y && (y = 6, d ? D.y += 12 - b.offsetHeight / 2 : D.x += 12 - b.offsetWidth / 2);
        var H = l;
        f || (H = 10);
        G = Y(a, "card-flip");
        a = Y(a, "card-reverse");
    ...
    zl.prototype.c = function (a) {
        ...
        if (b) {
            var c = vf(b);
            if (c == window.location.host || !c && 0 == b.lastIndexOf("/", 0)) if (c = xf(b), c = yf(c)) b = Gf(b, "v"), b == l && (b = "default_tag"), (a = ii(a)) && Fi(b, a)
        }
    };
    ...
    function gm() {
        ...
        X("/comment_servlet", {
            ...
            C: Hf(Qc(b)),
            j: function (b, c) {
                c && c.html_content ? (V(K("flag-comment-step1", a)), V(K("flag-comment-step2", a)), U(K("flag-comment-step3", a)), K("flag-comment-captcha-placeholder", a)
                    .innerHTML = c.html_content) : Lh.getInstance()
                    .cc()
            },
            onError: function (a, b) {
                var i = b && b.error_message;
                if (i) {
        ...
        if (!this.wa.disabled) {
            ...
            X(this.z.action, {
                ...
                S: function (a, b) {
                    ...
                    case "PENDING":
                        mm(this);
                        this.Xc.innerHTML = O("COMMENT_PENDING");
        ...
        case "flag-in-place":
            if (tm()) {
                ...
                Lh.getInstance()
                    .Pd(d);
                d = Mh();
                K("flagged-comment-id", d)
                    .value = a;
                K("flagged-comment-author-id", d)
                    .value = c;
                K("flagged-comment-video-id", d)
                    .value = g;
                tc(K("flagged-comment-author-name", d), e);
                K("flagged-comment-text", d)
                    .appendChild(jc(f));
            ...
            break;
        case "flag":
            tm() && (a = Q(b, "id"), c = L("VIDEO_ID"), V(b), x(b, "flagged"), X("/comment_servlet", {
                format: "XML",
                method: "POST",
                o: {
    ...
    p.Yc = m;
    p.getId = function () {
        return this.Fd || (this.Fd = ":" + (this.Qf.b++)
            .toString(36))
    };
    p.A = function () {
        return this.$
    ...
    p.tc = function (a) {
        ...
        Gm ? this.A()
            .placeholder = this.c : this.A()
            .setAttribute("aria-label", this.c)
    };
    p.rb = function () {
        Fm.J.rb.call(this);
        var a = new kj(this);
        ...
        Gm ? this.b = a : (Eb && mj(a, this.A(), ["keypress", "keydown", "keyup"], this.sf), mj(a, ac(this.A()) ? ac(this.A())
            .parentWindow || ac(this.A())
            .defaultView : window, "load", this.tf), this.b = a, Hm(this));
        Im(this);
        this.A()
            .c = this
    };
    ...
    p.sf = function (a) {
        27 == a.keyCode && ("keydown" == a.type ? this.f = this.A()
            .value : "keypress" == a.type ? this.A()
            .value = this.f : "keyup" == a.type && (this.f = l), a.preventDefault())
    };
    p.Of = function () {
        Jm(this) || (this.A()
            .value = "", pj(this.tg, this))
    };
    p.tg = function () {
        Jm(this) || (this.A()
            .value = this.c)
    ...
    function Im(a) {
        Gm ? a.A()
            .placeholder != a.c && (a.A()
            .placeholder = a.c) : (Hm(a), a.A()
            .setAttribute("aria-label", a.c));
        Jm(a) ? z(a.A(), "label-input-label") : (!a.M && !a.xb && x(a.A(), "label-input-label"), Gm || pj(a.Xf, a))
    }
    p.Xf = function () {
        this.A() && (!Jm(this) && !this.xb) && (this.A()
            .value = this.c)
    };
    ...
    p.lg = function (a, b) {
        function c(a) {
            return ae(a, "time-created") ? (a = Q(a, "time-created"), parseInt(a, 10)) : (new Date)
                .getTime() / 1E3
        }
        return c(b) - c(a)
    };
    ...
    p.Le = function (a) {
        ...
        if (!B(b, "selected")) {
            ...
            var a = Q(b, "playlist-id"),
                c = F("playlist-addto-top-checkbox")
                    .checked ? "True" : "False";
            x(b, "loading");
            X("/addto_ajax", {
                method: "POST",
    ...
    function Tm(a) {
        ...
        b && Jg(b, {
            ...
            S: function (a, b) {
                F("insight-optout-response")
                    .innerHTML = "error_message" in b ? b.error_message : ""
            }
        })
    };
    ...
    Vm.prototype.c = function (a) {
        ...
        X(this.z.action, {
            ...
            onError: function (a, c) {
                ...
                c && c.error_message && (K("yt-alert-content", f)
                    .innerHTML = c.error_message);
                U(f);
                b.disabled = m
            },
            B: this
    ...
    function bn(a) {
        ...
        if (L("ALLOW_RATINGS")) {
            ...
            if (b) if (L("YPC_SHOW_VPPA_CONFIRM_RATING") && !confirm(O("VPPA_CONFIRM"))) en();
            else {
                2 !== a && fn();
                an(m);
                gn(a);
                var b = {
                    ...
                    j: function (b, c) {
                        ...
                        0 === a ? A(f, "unliked", "liked") : 1 === a ? A(f, "liked", "unliked") : z(f, "liked", "unliked");
        ...
        (a = K("sign-in", this.N)) ? R(a, "click", t(this.Fe, this)) : (a = {
            ...
            j: function (a, c) {
                ...
                w(d, function (a) {
                    ...
                    for (var n = /<[^>]+>/g, y = r.match(n) || [], n = r.replace(n, "<wbr>")
                        .split("<wbr>"),
                    D = d.innerHTML, G = "", H = 0; 1 > H; H++) G += "&nbsp;<br>";
                    d.innerHTML = G;
                    G = d.clientHeight || d.offsetHeight;
                    d.innerHTML = D;
                    for (var D = 0, H = n.join("")
                        .length + 1, ka = []; D < H;) {
    ...
    function ao(a, b, c) {
        b && 0 < b.length && (b = bo(b), c && 0 < c.length && (b += "___" + bo(c)), c = b, b = Sn($n, "_p", Un()), Sn(b, c, Un())[a] = (new Date)
            .getTime(), b = Zn.r, "function" === typeof b ? b(a, "_p", c) : b.push([a, "_p", c]))
    }
    function bo(a) {
        return a.join("__")
            .replace(/\./g, "_")
    ...
    function no(a, b) {
        ...
        var e = d,
            f = e && e[fo.Bg];
        if (f) for (var g = 0; g < eo.length; g++) {
            var i = eo[g][0],
                n = eo[g][1];
            n && Object.prototype.hasOwnProperty.call(f, i) && n(f[i], a, e)
        }
        if (!(e = d[fo.Cg]))(e = Xn()) || h("Bad hint");
        var r = e,
            y = d[fo.ee],
            D = d[fo.Ag],
            f = d[fo.TIMEOUT],
        ...
        g = f = f.replace("__features__", ho(xa))
            .replace(/\/$/, "") + (e.length ? "/ed=1/exm=" + ho(e) : "") + ("/cb=gapi." + ed);
        i = g.match(lo);
    ...
    p.dd = function () {
        var a = Math.max((cc(window)
            .height - this.L.height) / 2, 0);
        Se(this.i, "top", a + "px")
    };
    p.ye = function () {
    ...
    function bp(a, b) {
        ...
        Wo(c, m);
        d && (ap(c, d), d = K("subscription-options-button", c), P(d, "loaded", "true"), So(d), "button" == Q(c, "subscription-menu-type") && nh.getInstance()
            .Sc(d))
    }
    function cp(a) {
    ...
    p.wf = function (a, b, c) {
        b = b.response.id;
        pp(this, a, b, c);
        a == this.tb && (lp(this, b), this.ga && (a = this.ga, a.c && (Al.getInstance()
            .zb(a.qa), a.md())))
    };
    p.xf = function (a, b) {
    ...
    function Ip(a, b) {
        if (Wd && !a.addEventListener) {
            ...
            .q && L("WIDE_PLAYER_STYLES") && (L("WATCH7_ENABLED") ? W("player-resize",
    ...
    function Kp(a) {
        ...
        if (b.b) {
            var c = {};
            c.volume = isNaN(a.volume) ? xp(b)
                .volume : Math.min(Math.max(a.volume, 0), 100);
            c.nonNormalized = a.nonNormalized;
            c.muted = a.muted == j ? xp(b)
                .muted : a.muted;
            try {
    ...
    if (navigator.plugins && navigator.plugins.length) {
        ...
        try {
            tq = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6"), oq = k, pq = "6.0.21"
        } catch (vq) {
            try {
    ...
    function er(a, b) {
        ...
        c && (c = J("li", "video-list-item", c), w(c, function (a, c) {
            ...
            w(f, function (a) {
                ...
                d && unescape(d)
                    .match(/\/watch(\?|#!)v=/) && (a.href = b ? a.href + ("&pvpos=" + c) : a.href + ("&pvnpos=" + c))
            })
        }))
    }
    ...
    function ur(a, b) {
        ...
        F(c)
            .innerHTML = ['<iframe name="fw_ad" id="fw_ad" ', 'width="' + d + '" height="' + e + '" ', 'marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no"></iframe>'].join("");
        var g = F("fw_ad"),
    ...
    u("yt.www.watch.ads.showForcedMpu", function (a) {
        F("ad300x250")
            .innerHTML = ['<iframe src="', a, '" name="ifr_300x250ad" id="ifr_300x250ad" width="300" height="250" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no"></iframe>'].join("");
        U("ad300x250")
    });
    u("yt.www.watch.ads.createGutSlot", function (a) {
        googletag && (nr = googletag.defineSlot(a, [[300, 250], [300, 60]], "yt-gut-content"), nr.set("ad_type", "flash"), nr.addService(googletag.companionAds()), googletag.enableServices(), a = nr.getSizes(), or = a[0], pr = a[1])
    });
    ...
    u("yt.www.watch.player.updateConfig", function (a) {
        ...
        (c = d.t || d.at) ? (Bp.t = d.t, Bp.at = d.at, d = window.location.hash.replace(/\bat=[^&]*&?/, ""), window.location.hash = d && "#" != d ? d : "#!", c = Sp(c)) : c = 0;
    ...
    u("yt.www.watch.actions.init", function () {
        ...
        if (b) {
            ...
            N(function () {
                pn("watch-actions-area-container")
                    .scrollIntoView()
            }, 0);
            delete a.action;
            a = Df(a) || "#!";
    ...
    u("yt.www.watch.actions.dismissChannelSubscriptionPromo", function () {
        ...
        (new Sm("ob_subscription_on_watch_promo", 0))
            .write("write_dismiss", j, zg(new yg(j), a))
    });
    ...
    u("yt.www.masthead.toggleExpandedMasthead", function () {
        ...
        if (!Q(a, "loaded")) {
            ...
            X("/playlist_bar_ajax", {
                ...
                pb: k,
                j: function (b, d) {
                    F("masthead-expanded-lists-container")
                        .innerHTML = d.html;
                    P(a, "loaded", "true")
                }
            })
    ...
    u("yt.www.subscriptions.edit.onUpdateSubscription", function (a, b, c, d) {
        ...
        b = Qc(F("subscription_level_uploads" + c)
            .form);
        Kg("/ajax_subscriptions?" + b, {
            postBody: "session_token=" + a,
            onComplete: function (a) {
                F("subscribeMessage" + c)
                    .innerHTML = Lg(Hg(a), "html_content");
                V("edit_subscription_wrapper" + c);
                V("edit_subscription_arrow" + c);
                U("subscribeMessage" + c);
                c && (F("edit_subscription_opener" + c)
                    .style.visibility = "", N(function () {
    ...
    u("yt.www.subscriptions.edit.onCancelUpdateSubscription", function (a) {
        ...
        a && (F("edit_subscription_opener" + a)
            .style.visibility = "");
        V("alerts")
    });
    ...
    ig("init", function () {
        if (L("YPC_LOADER_ENABLED")) {
            for (var a = 0; a < kq.length; a++) if (K(kq[a])) {
                lq();
                break
            }
    ...
    u("yt.www.watch.survey.takeWatchPageSurvey", function () {
        jq();
        window.open("/watch_page_survey?r2=" + L("SURVEY_REFERER") + "&r1=" + L("SURVEY_SERVLET_NAME") + "&name=" + L("SURVEY_TYPE"), "YouTube_User_Happiness_Survey", "toolbar=no,width=800,height=768,status=no,resizable=yes,fullscreen=no,scrollbars=yes")
            .focus()
    });
    ...
    u("yt.www.watch.context.init", function () {
        var a = new vp,
            b;
        b = (b = (new Ei(new xi))
            .get(L("VIDEO_ID", "default_tag"))) ? wg(b) : l;
        b ? (a.ja.da(b, a.b), b = k) : b = m;
        if (b && (U(a.b, "context-icon"), !L("WATCH7_ENABLED") && (a = F("watch-context-item-list")))) b = Q(a, "context-playing"), (b = parseInt(b, 10)) && uj.getInstance()
            .Ca(a, b);
        var c = new Ei(new xi),
            d = [];
